...
// RMA / SAC tem seus próprios tipos em client/src/rma/types.ts (mesmo
// padrão de client/src/marketplace/types.ts) - o módulo foi reformulado
// por completo, então os tipos antigos (RmaCaso/RmaEvento/RmaStats) não
// existem mais.
